...
uses
  ...
  GXS.Skydome,
  GXS.GLSLBumpShader,
  GXS.GLSLDiffuseSpecularShader,
  GXS.GLSLPostShaders,
  GXS.GLSLProjectedTextures,
  GXS.GLSLShader,
  GXS.SmoothNavigator,
  GXS.SMWaveOut,
  GXS.State,
...
function TgxColorProperty.ColorToBorderColor(aColor: TColorVector;
  selected: Boolean): TColor;
begin
