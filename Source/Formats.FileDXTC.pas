...
const
  cImageDataFormat8bits: array[0..3] of TgxImageDataFormat = (
    (ColorFlag: DDPF_RGB;
     RBits: $E0;
     GBits: $1C;
     BBits: $03;
  ...
  cImageDataFormat16bits: array[0..4] of TgxImageDataFormat = (
    (ColorFlag: DDPF_RGBA;
     RBits: $0F00;
     GBits: $F0;
     BBits: $0F;
  ...
  cImageDataFormat24bits: array[0..0] of TgxImageDataFormat = (
    (ColorFlag: DDPF_RGB;
     RBits: $FF0000;
     GBits: $FF00;
     BBits: $FF;
  ...
  cImageDataFormat32bits: array[0..6] of TgxImageDataFormat = (
    (ColorFlag: DDPF_RGBA;
     RBits: $FF;
     GBits: $FF00;
     BBits: $FF0000;
