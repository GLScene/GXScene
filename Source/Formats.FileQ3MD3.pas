...
procedure LoadQ3Anims(Animations:TgxActorAnimations;
...
var
  ...
  function GetMeshObjectByName(MeshObjects:TgxMeshObjectList; Name:string; var mesh:TgxMeshObject):Boolean;
  var
    i : integer;
  begin
    Result:=False;
