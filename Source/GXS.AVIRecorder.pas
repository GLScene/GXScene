...
type
  ...
  published
    ...
    property GXSceneViewer: TgxSceneViewer read FGXSceneViewer
      write SetGXSceneViewer;
...
procedure TgxAVIRecorder.SetGXSceneViewer(const Value: TgxSceneViewer);
begin
  FGXSceneViewer := Value;
  if Assigned(FGXSceneViewer) then
    FBuffer := FGXSceneViewer.Buffer
  else
    FBuffer := nil;
end;
