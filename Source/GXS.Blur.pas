...
type
  ...
  TgxBlurPreset = (pNone, pGlossy, pBeastView, pOceanDepth, pDream, pOverBlur, pAdvancedBlur);
  ...
  TgxAdvancedBlurImagePrepareEvent = procedure(Sender: TObject; BMP32: TgxBitmap32; var DoBlur: boolean) of object;
  ...
  private
    ...
    procedure SetOnAdvancedBlurImagePrepareEvent(const Value: TgxAdvancedBlurImagePrepareEvent);
  ...
  published
    ...
    property OnAdvancedBlurImagePrepareEvent: TgxAdvancedBlurImagePrepareEvent read FOnAdvancedBlurImagePrepareEvent write SetOnAdvancedBlurImagePrepareEvent;
  ...
  protected
    ...
    procedure InitializeObject(ASender: TObject; const ARci: TgxRenderContextInfo); virtual;
  public
...
procedure TgxBlur.SetOnAdvancedBlurImagePrepareEvent(const Value: TgxAdvancedBlurImagePrepareEvent);
begin
...
procedure TgxMotionBlur.DoRender(var ARci: TgxRenderContextInfo; ARenderSelf, ARenderChildren: Boolean);
begin
