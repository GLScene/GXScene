...
procedure TgxCanvas.FillEllipseGradient(const x, y: Integer; const xRadius, yRadius: Integer; const edgeColor: TColorVector);
begin
  StartPrimitive(GL_TRIANGLE_FAN);
...
procedure TgxCanvas.FillEllipseGradient(const x, y, xRadius, yRadius: Single; const edgeColor: TColorVector);
begin
  StartPrimitive(GL_TRIANGLE_FAN);
  glVertex2f(x, y); // really necessary now :)
  glColor4f(edgeColor.X, edgeColor.Y, edgeColor.Z, edgeColor.W);
...
procedure TgxCanvas.FillEllipseGradient(const x, y, Radius: Single; const edgeColor: TColorVector);
begin
