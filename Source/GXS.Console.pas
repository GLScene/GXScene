...
begin
  ...
  begin
    ...
    FShortHelp := 'displays GXSceneViewer FPS';
    FLongHelp.Add(FShortHelp);
  ...
  begin
    ...
    FShortHelp := 'resets GXSceneViewer FPS monitor';
    FLongHelp.Add(FShortHelp);
  ...
  begin
    ...
    FShortHelp := 'displays and allows to change GXSceneViewer VSync';
    FLongHelp.Add(FShortHelp);
  ...
  begin
    ...
    FShortHelp := 'displays and allows to change GXSceneViewer AntiAliasing';
    FLongHelp.Add(FShortHelp);
