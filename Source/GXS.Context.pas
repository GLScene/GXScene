...
{$ENDIF}
  ...
  protected
    ...
    class function IsValid(const ID: LongWord): GLboolean; virtual;
  ...
  protected
    ...
    class function IsValid(const ID: LongWord): GLboolean; override;
  public
...
function TgxProgramHandle.GetUniform4f(const index: string): TVector;
begin
  glGetUniformfv(GetHandle, GetUniformLocation(index), @Result);
end;

procedure TgxProgramHandle.SetUniform4f(const index: string; const val: TVector);
begin
...
function TgxProgramHandle.GetUniformMatrix4fv(const index: string): TMatrix;
begin
  glGetUniformfv(GetHandle, GetUniformLocation(index), @Result);
end;

procedure TgxProgramHandle.SetUniformMatrix4fv(const index: string; const val: TMatrix);
begin
...
function TgxProgramHandle.GetUniformOffset(const aName: string): PGLint;
begin
