          ...
          begin
            ...
            try
              ...
              begin
                ...
                Diffuse.Alpha := GXS.Utils.StrToFloatDef(objMtl.MaterialStringProperty(matName, 'd'), 1);
...
function TgxMTLFile.MaterialVectorProperty(const materialName, propertyName: string; const defaultValue: TVector): TVector;
var
  i: Integer;
  sl: TStringList;
begin
