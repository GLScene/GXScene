...
type
  ...
  TgxGizmoUpdateEvent = procedure(Sender: TObject; Obj: TgxBaseSceneObject;
    Axis: TgxGizmoAxis; Operation: TgxGizmoOperation; var Vector: TVector)
    of object;
  ...
  public
    ...
    function GetPickedObjectPoint(const Obj: TgxBaseSceneObject): TVector;
...
function TgxGizmo.GetPickedObjectPoint(const Obj: TgxBaseSceneObject): TVector;
var
  T: Integer;
...
function TgxGizmo.MouseWorldPos(const X, Y: Integer): TVector;
var
  V: TVector;
  InvertedY: Integer;
begin
...
var
  ...
  function LightLine(const Line: TgxLines; const Dark: TVector;
  ...
  function LightTorus(const Torus: TgxGizmoPickTorus; const Dark: TVector;
    const Axis: TgxGizmoAxis; AlterStyle: Boolean = False): Boolean;
  begin
  ...
  function LightCube(const Cube: TgxCube; const Dark: TVector;
    const Axis: TgxGizmoAxis; AlterStyle: Boolean = False): Boolean;
  begin
...
procedure TgxGizmo.UpdateGizmo(const NewDimensions: TVector);
begin
...
procedure TgxGizmoUndoItem.SetOldMatrix(const Value: TMatrix);
begin
  FOldMatrix := Value;
end;
