...
procedure RegisterRasterFormat(const AExtension, ADescription: string; AClass: TgxBaseImageClass);
begin
...
procedure TRasterFileFormatsList.Add(const Ext, Desc: string; DescID: Integer; AClass: TgxBaseImageClass);
var
...
function TgxBaseImage.GetData: PPixel32Array;
begin
  Result := fData;
end;

procedure TgxBaseImage.RegisterAsOpenVXTexture(
  AHandle: TgxTextureHandle;
  aMipmapGen: Boolean;
  aTexFormat: GLEnum;
  out texWidth: integer;
...
function TgxImage.GetScanLine(index: Integer): PPixel32Array;
begin
  Narrow;
...
procedure TgxImage.SetAlphaTransparentForColor(const aColor: TPixel32);
var
  color: TPixel24;
begin
  color.r := aColor.r;
...
procedure TgxImage.SetAlphaTransparentForColor(const aColor: TPixel24);
var
  i: Integer;
  intCol: Integer;
begin
