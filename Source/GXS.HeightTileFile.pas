...
type
   ...
   PHeightTileInfo = ^TgxHeightTileInfo;
...
procedure TgxHeightTileFile.PackTile(aWidth, aHeight : Integer; src : PSmallIntArray);
var
   packWidth : Integer;
...
// ExtractRow
//
procedure TgxHeightTileFile.ExtractRow(x, y, len : Integer; dest : PSmallIntArray);
var
   rx : Integer;
   n : Cardinal;
   tileInfo : PHeightTileInfo;
...
function TgxHeightTileFile.XYTileInfo(anX, anY : Integer) : PHeightTileInfo;
var
   tileList : TList;
begin
...
function TgxHeightTileFile.GetTiles(index : Integer) : PHeightTileInfo;
begin
   Result:=@FTileIndex[index];
end;

function TgxHeightTileFile.IndexOfTile(aTile : PHeightTileInfo) : Integer;
var
   c : Cardinal;
begin
