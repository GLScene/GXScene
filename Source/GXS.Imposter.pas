...
type
  ...
  TgxImposterBuilder = class(TUpdateAbleComponent)
  private
    FBackColor: TgxColor;
...
{
function TgxImposter.AxisAlignedDimensionsUnscaled : TVector;
begin
   Result:=NullHMGVector;
end;

function TgxImposter.CalcError(NewMatrix : TMatrix) : Single;
var
   i : Integer;
   mat : TMatrix;
   err : Single;
