...
procedure TgxPathNode.SetPositionAsVector(const Value: TVector);
begin
  FPosition := Value;
    (Collection as TgxPathNodes).NotifyChange;
end;

procedure TgxPathNode.SetRotationAsVector(const Value: TVector);
begin
  FRotation := Value;
    (Collection as TgxPathNodes).NotifyChange;
end;

procedure TgxPathNode.SetScaleAsVector(const Value: TVector);
begin
  FScale := Value;
    (Collection as TgxPathNodes).NotifyChange;
end;
