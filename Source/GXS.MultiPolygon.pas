...
type
  ...
  TgxPolygonList = class(TPersistentObjectList)
  private
...
function TgxPolygonList.GetList(i: Integer): TAffineVectorList;
begin
...
procedure TgxMultiPolygonBase.AddNode(const i: Integer; const value: TVector);
begin
...
function TgxMultiPolygonBase.AxisAlignedDimensionsUnscaled: TVector;
var
