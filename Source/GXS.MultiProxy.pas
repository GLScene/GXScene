...
function TgxMultiProxy.AxisAlignedDimensionsUnscaled: TVector;
var
  master: TgxBaseSceneObject;
begin
...
function TgxMultiProxy.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
