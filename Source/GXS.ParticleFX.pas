...
type
  ...
  TgxParticle = class(TPersistentObject)
  private
    FID, FTag: Integer;
  ...
  (* List of particles.
     ...
     check methods doc. *)
  TgxParticleList = class(TPersistentObject)
  private
...
procedure TgxParticleFXManager.DoProgress(const progressTime: TProgressTimes);
begin
  inherited;
...
procedure TgxSourcePFXEffect.DoProgress(const progressTime: TProgressTimes);
var
  n: Integer;
begin
...
procedure TgxDynamicPFXManager.DoProgress(const progressTime: TProgressTimes);
var
  i: Integer;
  curParticle: TgxParticle;
  maxAge: Double;
...
procedure TgxLifeColoredPFXManager.ComputeColors(var lifeTime: Single; var inner, outer: TColorVector);
var
  i, k, n: Integer;
  f: Single;
...
procedure TgxLifeColoredPFXManager.ComputeInnerColor(var lifeTime: Single; var inner: TColorVector);
var
  i, k, n: Integer;
  f: Single;
  lck, lck1: TPFXLifeColor;
...
procedure TgxLifeColoredPFXManager.ComputeOuterColor(var lifeTime: Single; var outer: TColorVector);
var
  i, k, n: Integer;
  f: Single;
  lck, lck1: TPFXLifeColor;
...
procedure TgxLifeColoredPFXManager.RotateVertexBuf(buf: TAffineVectorList;
...
procedure TgxCustomPFXManager.DoProgress(const progressTime: TProgressTimes);
var
  i: Integer;
  list: PGLParticleArray;
  curParticle: TgxParticle;
