...
procedure TgxROAMPatch.RenderHighRes(vertices: TAffineVectorList;
...
procedure TgxROAMPatch.RenderAccum(vertices: TAffineVectorList;
  VertexIndices: TIntegerList; TexCoords: TTexPointList;
  AutoFlushVertexCount: Integer);
var
...
class procedure TgxROAMPatch.FlushAccum(vertices: TAffineVectorList;
  VertexIndices: TIntegerList; TexCoords: TTexPointList);
begin
...
procedure TgxROAMPatch.RenderROAM(vertices: TAffineVectorList;
  vertexIndices: TIntegerList; texCoords: TTexPointList);
...
// RenderAsStrips
//
procedure TgxROAMPatch.RenderAsStrips(vertices: TAffineVectorList;
  VertexIndices: TIntegerList; TexCoords: TTexPointList);
