...
type
  ...
  TOnDrawTexture = function(const Sender: TgxBaseRandomHDS; x, y: integer; z: double; Normal: TVector): TColorVector of object;
  ...
  protected
    ...
    function OnDrawTextureDefault(const Sender: TgxBaseRandomHDS; x, y: integer; z: double; Normal: TVector): TColorVector;
...
function TgxBaseRandomHDS.OnDrawTextureDefault(const Sender: TgxBaseRandomHDS; x, y: integer; z: double; Normal: TVector)
  : TColorVector;
begin
...
procedure TgxBaseRandomHDS.SetLightColor(const Value: TColorVector);
begin
  FLightColor := Value;
end;

procedure TgxBaseRandomHDS.SetLightDirection(const Value: TVector);
var
  v: TVector;
begin
  v := Value;
...
procedure TgxCustomRandomHDS.BuildLightMap(const aLightDirection: TVector);
begin
...
function TgxCustomRandomHDS.Normal(const Position: TVector): TVector;
var
  x, y: integer;
begin
  if (FNormal <> nil) then
