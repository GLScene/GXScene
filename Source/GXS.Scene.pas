...
type
  ...
  public
    ...
    procedure PointTo(const ATargetObject: TgxBaseSceneObject; const AUpVector: TVector); overload;
...
function TgxBaseSceneObject.GetDirectAbsoluteMatrix: PMatrix;
begin
...
procedure TgxBaseSceneObject.ForceLocalMatrix(const aMatrix: TMatrix);
begin
...
function TgxBaseSceneObject.AbsoluteMatrixAsAddress: PMatrix;
begin
...
function TgxBaseSceneObject.InvAbsoluteMatrix: TMatrix;
begin
  Result := InvAbsoluteMatrixAsAddress^;
end;

function TgxBaseSceneObject.InvAbsoluteMatrixAsAddress: PMatrix;
begin
...
function TgxBaseSceneObject.GetAbsoluteMatrix: TMatrix;
begin
  Result := AbsoluteMatrixAsAddress^;
end;

procedure TgxBaseSceneObject.SetAbsoluteMatrix(const Value: TMatrix);
begin
...
function TgxBaseSceneObject.GetAbsoluteDirection: TVector;
begin
  Result := VectorNormalize(AbsoluteMatrixAsAddress^.z);
end;

procedure TgxBaseSceneObject.SetAbsoluteDirection(const v: TVector);
begin
  if Parent <> nil then
...
function TgxBaseSceneObject.GetAbsoluteScale: TVector;
begin
...
procedure TgxBaseSceneObject.SetAbsoluteScale(const Value: TVector);
begin
  if Parent <> nil then
...
function TgxBaseSceneObject.GetAbsoluteUp: TVector;
begin
  Result := VectorNormalize(AbsoluteMatrixAsAddress^.y);
end;

procedure TgxBaseSceneObject.SetAbsoluteUp(const v: TVector);
begin
  if Parent <> nil then
...
function TgxBaseSceneObject.AbsoluteRight: TVector;
begin
  Result := VectorNormalize(AbsoluteMatrixAsAddress^.x);
end;

function TgxBaseSceneObject.AbsoluteLeft: TVector;
begin
  Result := VectorNegate(AbsoluteRight);
end;

function TgxBaseSceneObject.GetAbsolutePosition: TVector;
begin
  Result := AbsoluteMatrixAsAddress^.W;
end;

procedure TgxBaseSceneObject.SetAbsolutePosition(const v: TVector);
begin
...
function TgxBaseSceneObject.AbsolutePositionAsAddress: PVector;
begin
  Result := @AbsoluteMatrixAsAddress^.W;
end;

function TgxBaseSceneObject.AbsoluteXVector: TVector;
begin
  AbsoluteMatrixAsAddress;
  SetVector(Result, PAffineVector(@FAbsoluteMatrix.x)^);
end;

function TgxBaseSceneObject.AbsoluteYVector: TVector;
begin
  AbsoluteMatrixAsAddress;
  SetVector(Result, PAffineVector(@FAbsoluteMatrix.y)^);
end;

function TgxBaseSceneObject.AbsoluteZVector: TVector;
begin
  AbsoluteMatrixAsAddress;
  SetVector(Result, PAffineVector(@FAbsoluteMatrix.z)^);
end;

function TgxBaseSceneObject.AbsoluteToLocal(const v: TVector): TVector;
begin
...
function TgxBaseSceneObject.LocalToAbsolute(const v: TVector): TVector;
begin
...
function TgxBaseSceneObject.Right: TVector;
begin
  Result := VectorCrossProduct(FDirection.AsVector, FUp.AsVector);
end;

function TgxBaseSceneObject.LeftVector: TVector;
begin
  Result := VectorCrossProduct(FUp.AsVector, FDirection.AsVector);
end;

function TgxBaseSceneObject.BarycenterAbsolutePosition: TVector;
begin
...
function TgxBaseSceneObject.SqrDistanceTo(const pt: TVector): Single;
begin
...
function TgxBaseSceneObject.DistanceTo(const pt: TVector): Single;
begin
  Result := VectorDistance(AbsolutePosition, pt);
end;

function TgxBaseSceneObject.BarycenterSqrDistanceTo(const pt: TVector): Single;
var
  d: TVector;
begin
...
function TgxBaseSceneObject.AxisAlignedDimensions: TVector;
begin
  Result := AxisAlignedDimensionsUnscaled();
  ScaleVector(Result, Scale.AsVector);
end;

function TgxBaseSceneObject.AxisAlignedDimensionsUnscaled: TVector;
begin
  Result.x := 0.5;
  Result.y := 0.5;
  Result.z := 0.5;
...
function TgxBaseSceneObject.PointInObject(const point: TVector): Boolean;
var
  localPt, dim: TVector;
begin
...
function TgxBaseSceneObject.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
...
procedure TgxBaseSceneObject.PointTo(const ATargetObject: TgxBaseSceneObject; const AUpVector: TVector);
begin
  PointTo(ATargetObject.AbsolutePosition, AUpVector);
end;

procedure TgxBaseSceneObject.PointTo(const AAbsolutePosition, AUpVector: TVector);
var
...
function TgxBaseSceneObject.GetLocalMatrix: PMatrix;
begin
  Result := @FLocalMatrix;
end;
...
function TgxBaseSceneObject.GetMatrix: PMatrix;
begin
  RebuildMatrix;
  Result := @FLocalMatrix;
end;

procedure TgxBaseSceneObject.SetMatrix(const aValue: TMatrix);
begin
  FLocalMatrix := aValue;
...
function TgxCamera.AbsoluteVectorToTarget: TVector;
begin
...
function TgxCamera.AbsoluteRightVectorToTarget: TVector;
begin
  if TargetObject <> nil then
  begin
    VectorSubtract(TargetObject.AbsolutePosition, AbsolutePosition, Result);
...
function TgxCamera.AbsoluteUpVectorToTarget: TVector;
begin
  if TargetObject <> nil then
...
function TgxCamera.AbsoluteEyeSpaceVector(forwardDistance, rightDistance, upDistance: Single): TVector;
begin
...
function TgxCamera.ScreenDeltaToVector(deltaX, deltaY: Integer; ratio: Single; const planeNormal: TVector): TVector;
var
...
function TgxCamera.ScreenDeltaToVectorXY(deltaX, deltaY: Integer; ratio: Single): TVector;
var
  screenY: TVector;
  dxr, dyr, d: Single;
begin
...
function TgxCamera.ScreenDeltaToVectorXZ(deltaX, deltaY: Integer; ratio: Single): TVector;
var
  screenY: TVector;
  d, dxr, dzr: Single;
begin
...
function TgxCamera.ScreenDeltaToVectorYZ(deltaX, deltaY: Integer; ratio: Single): TVector;
var
  screenY: TVector;
  d, dyr, dzr: Single;
begin
...
function TgxCamera.PointInFront(const point: TVector): Boolean;
begin
...
function TgxCamera.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
  intersectNormal: PVector = nil): Boolean;
begin
  Result := False;
end;
...
function TgxProxyObject.AxisAlignedDimensions: TVector;
begin
...
function TgxProxyObject.AxisAlignedDimensionsUnscaled: TVector;
begin
  if Assigned(FMasterObject) then
  begin
    Result := FMasterObject.AxisAlignedDimensionsUnscaled;
...
function TgxProxyObject.BarycenterAbsolutePosition: TVector;
var
...
function TgxProxyObject.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
  intersectNormal: PVector = nil): Boolean;
var
...
function TgxLightSource.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
  intersectNormal: PVector = nil): Boolean;
begin
  Result := False;
end;
...
function TgxScene.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
  intersectNormal: PVector = nil): TgxBaseSceneObject;
var
  bestDist2: Single;
...
procedure TgxSceneBuffer.PushViewMatrix(const newMatrix: TMatrix);
var
  n: Integer;
begin
...
procedure TgxSceneBuffer.PushProjectionMatrix(const newMatrix: TMatrix);
var
  n: Integer;
begin
...
function TgxSceneBuffer.ViewMatrix: TMatrix;
begin
  Result := RenderingContext.PipeLineTransformation.ViewMatrix^;
end;

function TgxSceneBuffer.ModelMatrix: TMatrix;
begin
...
function TgxSceneBuffer.ScreenToWorld(const aPoint: TVector): TVector;
begin
...
function TgxSceneBuffer.WorldToScreen(const aPoint: TVector): TVector;
begin
  SetVector(Result, WorldToScreen(AffineVectorMake(aPoint)));
end;

procedure TgxSceneBuffer.WorldToScreen(points: PVector; nbPoints: Integer);
var
  i: Integer;
begin
  if Assigned(FCamera) then
...
function TgxSceneBuffer.ScreenToVector(const aPoint: TVector): TVector;
begin
  SetVector(Result, VectorSubtract(ScreenToWorld(aPoint), FCameraAbsolutePosition));
  Result.W := 0;
end;

function TgxSceneBuffer.ScreenToVector(const x, y: Integer): TVector;
var
  av: TAffineVector;
begin
  av.x := x;
...
function TgxSceneBuffer.ScreenVectorIntersectWithPlane(const aScreenPoint: TVector; const planePoint, planeNormal: TVector;
  var intersectPoint: TVector): Boolean;
var
  v: TVector;
begin
...
function TgxSceneBuffer.ScreenVectorIntersectWithPlaneXY(const aScreenPoint: TVector; const z: Single;
  var intersectPoint: TVector): Boolean;
begin
...
function TgxSceneBuffer.ScreenVectorIntersectWithPlaneYZ(const aScreenPoint: TVector; const x: Single;
  var intersectPoint: TVector): Boolean;
begin
...
function TgxSceneBuffer.ScreenVectorIntersectWithPlaneXZ(const aScreenPoint: TVector; const y: Single;
  var intersectPoint: TVector): Boolean;
begin
