...
procedure TgxSilhouette.SetIndices(const value: TIntegerList);
begin
  FIndices.Assign(value);
end;

procedure TgxSilhouette.SetCapIndices(const value: TIntegerList);
begin
  FCapIndices.Assign(value);
end;

procedure TgxSilhouette.SetVertices(const value: TVectorList);
begin
