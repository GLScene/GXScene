...
function ExtendedFrustumMakeFromSceneViewer(const AFrustum: TFrustum; const AGXSceneViewer: TgxSceneViewer): TExtendedFrustum;
// old version
begin
  Assert(Assigned(AGXSceneViewer.Camera), 'GXSceneViewer must have camera specified!');
  result := ExtendedFrustumMake(AFrustum, AGXSceneViewer.Camera.NearPlane, AGXSceneViewer.Camera.DepthOfView,
    AGXSceneViewer.FieldOfView, AGXSceneViewer.Camera.Position.AsAffineVector, AGXSceneViewer.Camera.Direction.AsAffineVector);
end;
