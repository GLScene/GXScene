...
function TgxTerrainRenderer.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
...
function TgxTerrainRenderer.InterpolatedHeight(const p: TVector): single;
var
  pLocal: TVector;
begin
  if Assigned(HeightDataSource) then
