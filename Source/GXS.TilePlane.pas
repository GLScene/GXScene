...
type
  ...
  TgxTiledAreaRow = class(TPersistentObject)
  private
  ...
  { Stores tile information in a tiled area.
    ...
    assumed as "empty". }
  TgxTiledArea = class(TPersistentObject)
  private
...
procedure TgxTiledAreaRow.RemapTiles(remapList: TIntegerList);
var
  i, k: Integer;
begin
  for i := 0 to FData.Count - 1 do
...
// RemapTiles
//
procedure TgxTiledArea.RemapTiles(remapList: TIntegerList);
var
  i: Integer;
  r: TgxTiledAreaRow;
begin
