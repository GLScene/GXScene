...
type
  ...
  public
    ...
    procedure CreateMark(obj: TgxBaseSceneObject; width: single; CurrentTime: Double); overload;
  ...
  published
    ...
    property TrailObject: TgxBaseSceneObject read FTrailObject write SetTrailObject default nil;
...
procedure TgxTrail.CreateMark(obj: TgxBaseSceneObject; width: single;CurrentTime : Double);
var
...
procedure TgxTrail.CreateMark(APos,ADir,AUp: TVector3f; AWidth: single;ACurrentTime : Double);
var
...
procedure TgxTrail.Notification(AComponent: TComponent;
