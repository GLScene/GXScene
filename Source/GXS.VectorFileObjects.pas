...
type
  ...
  TgxSkeleton = class(TPersistentObject)
  private
    FOwner: TgxBaseMesh;
  ...
  TgxMeshObjectList = class(TPersistentObjectList)
  private
    FOwner: TgxBaseMesh;
  ...
  TgxMeshMorphTargetList = class(TPersistentObjectList)
  private
    FOwner: TPersistent;
  protected
  ...
  TgxFaceGroup = class(TPersistentObject)
  private
...
type
  ...
  TgxVectorFileFormatsList = class(TPersistentObjectList)
  public
    destructor Destroy; override;
...
procedure TgxBaseMeshObject.BuildNormals(vertexIndices: TIntegerList; mode: TgxMeshObjectMode;
...
function TgxBaseMeshObject.ExtractTriangles(texCoords: TAffineVectorList = nil; normals: TAffineVectorList = nil)
  : TAffineVectorList;
begin
...
procedure TgxBaseMeshObject.SetVertices(const val: TAffineVectorList);
begin
  FVertices.Assign(val);
end;

procedure TgxBaseMeshObject.SetNormals(const val: TAffineVectorList);
begin
  FNormals.Assign(val);
end;
...
procedure TgxSkeletonFrame.SetPosition(const val: TAffineVectorList);
begin
  FPosition.Assign(val);
end;

procedure TgxSkeletonFrame.SetRotation(const val: TAffineVectorList);
begin
...
procedure TgxSkeletonBone.SetGlobalMatrix(Matrix: TMatrix); // ragdoll
begin
  FGlobalMatrix := Matrix;
end;

procedure TgxSkeletonBone.SetGlobalMatrixForRagDoll(RagDollMatrix: TMatrix);
// ragdoll
begin
...
procedure TgxSkeletonCollider.SetLocalMatrix(const val: TMatrix);
begin
  FLocalMatrix := val;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      TVectorList(FTexCoordsEx[i]).Assign(TgxMeshObject(Source).FTexCoordsEx[i]);
    end;
  end;
end;
...
function TgxMeshObject.ExtractTriangles(texCoords: TAffineVectorList = nil; normals: TAffineVectorList = nil)
  : TAffineVectorList;
begin
  case mode of
    momTriangles:
...
function TgxMeshObject.GetBarycenter: TVector;
var
...
procedure TgxMeshObject.SetTexCoords(const val: TAffineVectorList);
begin
  FTexCoords.Assign(val);
end;

procedure TgxMeshObject.SetLightmapTexCoords(const val: TAffineVectorList);
begin
  FLightMapTexCoords.Assign(val);
end;

procedure TgxMeshObject.SetColors(const val: TVectorList);
begin
  FColors.Assign(val);
end;

procedure TgxMeshObject.SetTexCoordsEx(Index: Integer; const val: TVectorList);
begin
  TexCoordsEx[index].Assign(val);
end;

function TgxMeshObject.GetTexCoordsEx(Index: Integer): TVectorList;
var
  i: Integer;
begin
...
procedure TgxMeshObject.SetBinormals(const val: TVectorList);
begin
  Binormals.Assign(val);
end;

function TgxMeshObject.GetBinormals: TVectorList;
begin
...
procedure TgxMeshObject.SetTangents(const val: TVectorList);
begin
  Tangents.Assign(val);
end;

function TgxMeshObject.GetTangents: TVectorList;
begin
...
procedure TgxMeshObject.GetTriangleData(tri: Integer; list: TAffineVectorList; var v0, v1, v2: TAffineVector);
var
...
procedure TgxMeshObject.GetTriangleData(tri: Integer; list: TVectorList; var v0, v1, v2: TVector);
var
  i, LastCount, Count: Integer;
  fg: TFGVertexIndexList;
begin
...
procedure TgxMeshObject.SetTriangleData(tri: Integer; list: TAffineVectorList; const v0, v1, v2: TAffineVector);
var
  i, LastCount, Count: Integer;
  fg: TFGVertexIndexList;
begin
...
procedure TgxMeshObject.SetTriangleData(tri: Integer; list: TVectorList; const v0, v1, v2: TVector);
var
  i, LastCount, Count: Integer;
  fg: TFGVertexIndexList;
begin
...
function TgxMeshObjectList.ExtractTriangles(texCoords: TAffineVectorList = nil; normals: TAffineVectorList = nil)
  : TAffineVectorList;
var
  i: Integer;
  obj: TgxMeshObject;
...
begin
  ...
  begin
    ...
    for i := 1 to VerticeBoneWeightCapacity - 1 do
      newArea[i] := PVertexBoneWeightArray(Cardinal(newArea[0]) + Cardinal(i * SizeOf(TVertexBoneWeight) * BonesPerVertex));
    // transfer old data
...
procedure TgxSkeletonMeshObject.AddWeightedBones(const boneIDs: TVertexBoneWeightDynArray);
var
  i: Integer;
  n: Integer;
begin
...
function TgxSkeletonMeshObject.FindOrAdd(const boneIDs: TVertexBoneWeightDynArray; const vertex, normal: TAffineVector)
  : Integer;
var
  i, j: Integer;
  bonesMatch: Boolean;
...
procedure TgxFaceGroup.AddToTriangles(aList: TAffineVectorList; aTexCoords: TAffineVectorList = nil;
...
procedure TFGVertexIndexList.BuildList(var mrci: TgxRenderContextInfo);
const
...
procedure TgxFaceGroups.AddToTriangles(aList: TAffineVectorList; aTexCoords: TAffineVectorList = nil;
  aNormals: TAffineVectorList = nil);
var
  i: Integer;
begin
...
function TgxBaseMesh.AxisAlignedDimensionsUnscaled: TVector;
var
  dMin, dMax: TAffineVector;
begin
...
function TgxBaseMesh.BarycenterOffset: TVector;
var
  dMin, dMax: TAffineVector;
begin
...
function TgxBaseMesh.BarycenterPosition: TVector;
begin
  Result := VectorAdd(Position.DirectVector, BarycenterOffset);
end;

function TgxBaseMesh.BarycenterAbsolutePosition: TVector;
begin
...
function TgxBaseMesh.RayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
  intersectNormal: PVector = nil): Boolean;
var
  i: Integer;
...
function TgxFreeForm.OctreeRayCastIntersect(const rayStart, rayVector: TVector; intersectPoint: PVector = nil;
  intersectNormal: PVector = nil): Boolean;
var
...
function TgxFreeForm.OctreePointInMesh(const Point: TVector): Boolean;
const
...
function TgxFreeForm.OctreeSphereSweepIntersect(const rayStart, rayVector: TVector; const velocity, radius: Single;
  intersectPoint: PVector = nil; intersectNormal: PVector = nil): Boolean;
var
  locRayStart, locRayVector: TVector;
begin
...
function TgxFreeForm.OctreeAABBIntersect(const aabb: TAABB; objMatrix, invObjMatrix: TMatrix;
  triangles: TAffineVectorList = nil): Boolean;
var
  m1to2, m2to1: TMatrix;
begin
...
RegisterClasses([TgxFreeForm, TgxActor, TgxSkeleton, TgxSkeletonFrame, TgxSkeletonBone, TgxSkeletonMeshObject, TgxMeshObject,
  TgxSkeletonFrameList, TgxMeshMorphTarget, TgxMorphableMeshObject, TgxFaceGroup, TFGVertexIndexList,
