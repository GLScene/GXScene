...
procedure TgxVerletHair.BuildHair(const AAnchorPosition, AHairDirection: TAffineVector);
var
  i : integer;
...
function TgxVerletHair.GetAnchor: TVerletNode;
begin
  result := NodeList[1];
end;
...
function TgxVerletHair.GetRoot: TVerletNode;
begin
  result := NodeList[0];
end;

procedure TgxVerletHair.SetStiffness(const Value: TVHStiffnessSet);
begin
  FStiffness := Value;
  BuildStiffness;
end;
