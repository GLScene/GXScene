...
procedure ODERToSceneMatrix(var m: TMatrix; R: TdMatrix3; pos: TdVector3); overload;
procedure ODERToSceneMatrix(var m: TMatrix; R: PdMatrix3; pos: PdVector3); overload;
procedure ODERToSceneMatrix(var m: TMatrix; R: TdMatrix3_As3x4; pos:  TdVector3); overload;
function SceneMatrixToODER(m: TMatrix): TdMatrix3;
...
function SceneMatrixFromGeom(Geom: PdxGeom): TMatrix;
function SceneDirectionFromGeom(Geom: PdxGeom): TVector;
...
procedure ODERToSceneMatrix(var m: TMatrix; R: PdMatrix3; pos: PdVector3);
begin
  ODERToSceneMatrix(m, TdMatrix3_As3x4(R^), pos^);
end;

procedure ODERToSceneMatrix(var m: TMatrix; R: TdMatrix3; pos: TdVector3);
begin
  ODERToSceneMatrix(m, TdMatrix3_As3x4(R), pos);
end;
