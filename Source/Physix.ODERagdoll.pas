...
type
  ...
  private
    ...
    FGXSceneRoot: TgxBaseSceneObject;
  ...
  public
    ...
    property GXSceneRoot: TgxBaseSceneObject read FGXSceneRoot
      write FGXSceneRoot;
...
procedure TgxODERagdollBone.AlignBodyToMatrix(Mat: TMatrix); // By Stuart Gooding
var
  R: TdMatrix3;
begin
...
begin
  ...
  FGeom.data := FRagdoll.GXSceneRoot.AddNewChild(TgxODERagdollCube);
...
begin
  ...
  begin
    ...
    FRagdoll.GXSceneRoot.Remove(o, False);
    o.free;
  end;
