...
begin
  raise Exception.Create
    ('GXS.Keyboard.IsKeyDown(c : Char) not yet implemented for your platform!');
end;
{$ENDIF}
...
{$ELSE}
    raise Exception.Create
      ('GXS.Keyboard.IsKeyDown(vk : TVirtualKeyCode) not fully yet implemented for your platform!');
{$ENDIF}
  end;
end;
...
begin
  raise Exception.Create
    ('GXS.Keyboard.KeyPressed not yet implemented for your platform!');
end;
{$ENDIF}
// ------------------------------------------------------------------
...
{$ELSE}
    raise Exception.Create
      ('GXS.Keyboard.VirtualKeyCodeToKeyName not yet fully implemented for your platform!');
{$ENDIF}
  end;
end;
...
begin
  ...
  if (Result = -1) and lExceptionWasRaised then
    raise Exception.Create
      ('GXS.Keyboard.KeyNameToVirtualKeyCode not yet fully implemented for your platform or keyName wasn''t found!');
end;
{$ENDIF}
